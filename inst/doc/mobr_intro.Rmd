...
relative strength of these effects. Note here we set the argument \code{log_scale}
to \code{TRUE} because there is a large number of individuals and it is not
